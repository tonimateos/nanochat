...
parser.add_argument("--wandb-log-every", type=int, default=100, help="log metrics to wandb every N steps")
...
while True:
    ...
    if args.eval_every > 0 and (last_step or step % args.eval_every == 0):
        print0(f"Step {step:05d} | Starting validation evaluation on {args.eval_tokens:,} tokens...")
        model.eval()
    ...
    if step % args.wandb_log_every == 0:
        log_data = {
            "step": step,
            "total_training_flops": flops_so_far,
            "total_training_time": total_training_time,
